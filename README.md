...
Refactored Flask backend and a new Vue 3 frontend. The original React app remains in `SmartHive` for reference.

The old `run.py` listened on port **5001** while clients called **5000**. This backend defaults to **5000**.
...
Vue 3, Vite, Vue Router, and Pinia. No UI kit.
...
Open http://localhost:5173. The app talks to `VITE_API_URL` (default `http://127.0.0.1:5000`).
